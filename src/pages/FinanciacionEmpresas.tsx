        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4">Alquiler Modular</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4">Leasing: Proyectos Llave en Mano</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4">Renting de Bienes Muebles</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-4">Ventajas de Financiación en Unimodul</h2>
              <ul className="list-disc pl-6 mb-6">
